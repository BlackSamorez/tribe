...
parser.add_argument('--aquant', default=None, type=str, choices=[None, 'fp8', 'fp4_quest', 'fp4_absmax', 'nvfp4'])
parser.add_argument('--extra_wscaling_scheme', default=None, type=str, choices=[None, 'nvfp4'])
